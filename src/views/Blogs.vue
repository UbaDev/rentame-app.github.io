    ...
    <div class="blog-card-wrap">
        ...
        <div class="header">
            <div class="categorias">
                ...
                <div class="casa">
                    <router-link class="icon" :to="{ name: 'BlogsCasas' }"><img src="../assets/Icons/casa.png"
                            alt="casa" />
                        <div>Casas</div>
                    </router-link>
                ...
                <div class="departamento">
                    <router-link class="icon" :to="{ name: 'BlogsDepas' }"><img src="../assets/Icons/departamento.png"
                            alt="casa" />
                ...
                <div class="oficina">
                    <router-link class="icon" :to="{ name: 'BlogsOficinas' }"><img src="../assets/Icons/escritorio.png"
                            alt="casa" />
                        <div>Oficinas</div>
                    </router-link>
                ...
                <div class="cuarto">
                    <router-link class="icon" :to="{ name: 'BlogsCuartos' }"><img src="../assets/Icons/cuarto.png"
                            alt="casa" />
                        <div>Cuartos</div>
                    </router-link>
...
export default {
    ...
    computed: {
        ...
        blogDepartamentos() {
            return this.$store.state.blogDepartamentos
        },
        blogOficinas() {
            return this.$store.state.blogOficinas
        },
        blogCuartos() {
            return this.$store.state.blogCuartos
        },
